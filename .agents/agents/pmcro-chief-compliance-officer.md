...
`selected_reasoning_strategy` drawn from `omode/cco.yaml`'s trigger table, instead of
...
`plugins/pmcro-csuite/agents/cco.md` is the source of truth. In summary: may
