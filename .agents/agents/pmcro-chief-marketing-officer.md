...
`selected_reasoning_strategy` drawn from `omode/cmo.yaml`'s trigger table, instead of
...
`plugins/pmcro-csuite/agents/cmo.md` is the source of truth. In summary: may
