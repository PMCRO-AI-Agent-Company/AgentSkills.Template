...
`selected_reasoning_strategy` drawn from `omode/cdo.yaml`'s trigger table, instead of
...
`plugins/pmcro-csuite/agents/cdo.md` is the source of truth. In summary: may
