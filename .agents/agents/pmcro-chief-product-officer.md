...
`selected_reasoning_strategy` drawn from `omode/cpo.yaml`'s trigger table, instead of
...
`plugins/pmcro-csuite/agents/cpo.md` is the source of truth. In summary: may
