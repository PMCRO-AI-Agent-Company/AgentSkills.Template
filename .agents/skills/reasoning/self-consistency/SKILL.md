...
description: Sample multiple independent traces and take consensus. USE FOR verifiable answers. DO NOT USE for open-ended creative work.
license: Apache-2.0
metadata:
  version: "1.0.0"
  reasoning:
...
## Purpose
Reduce single-trace brittleness via majority/consensus over independent solutions.
