...
- Financial strategy, planning, or decision-making tasks for the AI Agent Company
...
- Agent Directory entry: `.pmcro/directory/agents.yaml` (id: pmcro-chief-financial-officer)
