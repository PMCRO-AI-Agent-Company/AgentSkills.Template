...
description: Apply a named reasoning strategy from the pmcro-omode catalog to a given input and return a ReasoningTraceFrame. USE FOR executing a strategy once select-reasoning-strategy (or a caller) has already chosen one. DO NOT USE to pick which strategy to use.
license: Apache-2.0
metadata:
  version: "0.1.0"
  tier: DOMAIN
