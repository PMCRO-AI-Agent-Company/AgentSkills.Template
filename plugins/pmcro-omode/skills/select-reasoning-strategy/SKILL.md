...
description: Given a task description and an optional allowed-families filter, recommend one reasoning strategy id from the pmcro-omode catalog. USE FOR any caller (a pmcro-csuite Chief, Orchestrator, or a human) that needs to pick a strategy before applying one. DO NOT USE to apply the strategy itself.
license: Apache-2.0
metadata:
  version: "0.1.0"
  tier: DOMAIN
...
Canonical, parameterized selector for the whole `pmcro-omode`
