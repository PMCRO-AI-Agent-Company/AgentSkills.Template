...
plugins/pmcro-reasoning-strategy. Declarative source -> generated projection,
...
## Output
Return a `ReasoningTraceFrame`: `strategy_id: "{spec['id']}"`, `steps` ({spec['steps_description'].strip()}), `result`."""
...
def main() -> int:
    ...
    parser.add_argument("--output-root", default="plugins/pmcro-reasoning-strategy/agents")
